...
const scope = 'user-read-playback-state user-modify-playback-state user-library-read playlist-read-private playlist-read-public playlist-read-collaborative';
